...
def create_video_from_csv(csv_type, csv_data, mp4_file_name):
    ...
    for i, data in enumerate(csv_data, start=1118):
        ...
        # final_video.write_videofile(filename, fps=30, codec='libx264', audio_codec='aac', codec='h264_nvenc')
        final_video.write_videofile(filename, fps=30, threads=1, codec='h264_nvenc')
...
def main():
    ...
    if mode == 4:
        file_name = f"Bet you didnt know this #shorts #quiz #questions #animals #pets #dogs #cats #random #fyp _" # _ will be replaced by number
        csv_type = "quiz"
